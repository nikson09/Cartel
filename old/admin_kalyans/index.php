          ...
          <div class="row">
              ...
              <div class="breadcrumbs">
                  <ol class="breadcrumb">
                      ...
                      <li class="active">Управление категорией кальяны</li>
                  </ol>
              </div>
      </div>
          <a data-toggle="modal" data-target="#create_product" class="btn btn-default back"><i class="fa fa-plus"></i> Добавить Товар</a>
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#category_modal">Категории Кальянов</button>
          <br/>
...
<script type="text/javascript">
    ...
    function addProduct()
    {
      ...
      $.ajax({
        type:'POST',
        url:'/admin/caterKalyans/product/create',
        data:formData,
            processData: false,
            contentType: false,
            dataType: "json",
    ...
    function updateProduct()
    {
      ...
      $.ajax({
        type:'POST',
        url:'/admin/caterKalyans/product/update/'+id,
        data:formData,
            processData: false,
            contentType: false,
            dataType: "json",
    ...
    function openEditProduct(id)
    {
      $('#edit_product').modal('show');
        var post = $.ajax({
            method: 'POST',
            url: "/admin/caterKalyans/getProduct/"+ id,
    ...
    function deleteProduct(id)
    {
        var post = $.ajax({
            ...
            url: "/admin/caterKalyans/delete/"+ id,
            success : function(result){
                result = JSON.parse(result);
                if(result.status){
    ...
    function categoriesTable()
    {
       $('#category_table').DataTable({
          ...
          'serverMethod': 'post',
          'ajax': {
              'url':'/admin/caterKalyans/categoryTable'
          },
          'columns': [
             { data: 'image' },
             { data: 'id' },
    ...
    function addCategory()
    {
      ...
      $.ajax({
        type:'POST',
        url:'/admin/caterKalyans/createCategory',
        data:formData,
            processData: false,
            contentType: false,
            dataType: "json",
    ...
    function openEditCategory(id)
    {
      $('#edit_category').modal('show');
        var post = $.ajax({
            method: 'POST',
            url: "/admin/caterKalyans/getCategory/"+ id,
            success : function(result){
                result = JSON.parse(result);
                if(result.status){
                  var image  = $('#myImgSSS').attr('src','/upload/images/categories/kalyan/'+id+'.jpg');
    ...
    function updateCategory()
    {
      ...
      $.ajax({
        type:'POST',
        url:'/admin/caterKalyans/updateCategory/'+ id,
        data:formData,
            processData: false,
            contentType: false,
            dataType: "json",
    ...
    function deleteCategory(id)
    {
        var post = $.ajax({
            ...
            url: "/admin/caterKalyans/deleteCategory/"+ id,
            success : function(result){
                result = JSON.parse(result);
                if(result.status){
