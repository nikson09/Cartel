...
<br/>
           <h4 class="text-center">Редактировать заказ #<?php echo $id; ?></h4>
            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post">
                        ...
                        <p>Выбор Связи</p>
                        <input type="text" name="userConnection" placeholder="" value="<?php echo $order['user_connection']; ?>">
                        <p>Область</p>
                        <input type="text" name="userOblast" placeholder="" value="<?php echo $order['user_oblast']; ?>">
                        <p>Город</p>
                        <input type="text" name="userCity" placeholder="" value="<?php echo $order['user_city']; ?>">
