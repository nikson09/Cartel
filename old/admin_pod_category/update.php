        ...
        <div class="row">
            ...
            <div class="breadcrumbs">
                <ol class="breadcrumb">
                    ...
                    <div class="divider_n"></div>
                    <li class="active">Редактировать подкатегорию</li>
                </ol>
            </div></div>

<br/>
            <h4 class="text-center">Редактировать подкатегорию "<?php echo $category['name']; ?>"</h4>
                            ...
                            <?php if (is_array($categoriesList)): ?>
                                <?php foreach ($categoriesList as $ascategory): ?>
                                    <option value="<?php echo $ascategory['id']; ?>" 
                                        <?php if ($category['parent'] == $ascategory['id']) echo ' selected="selected"'; ?>>
