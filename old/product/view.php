...
<script type="application/ld+json">
{
  ...
  "@type": "Product", 
  "name": "<?php echo $product['name_site'];?>",
  "image": "https://drinkking.com.ua/upload/images/products/<?php echo $product['id']; ?>.jpg",
  "description": "<?php echo $product['description'];?>",
  "brand": "<?php echo $pod_category['name'];?>",
  "offers": {
    "@type": "Offer",
    "url": "https://drinkking.com.ua/product/<?php echo $product['id']; ?>",
    "priceCurrency": "UAH",
...
<?php endif; ?>
                            ...
                            <div class="col-7">
                                <div class="product-information"><!--/product-information-->
                                    ...
                                    <?php endif; ?>
                                    <h2 ><?php echo $product['name_site'];?></h2>
                                    <p  class=" voted text-left">Код товара:<?php echo $product['code'];?></p>
                                    <div  class="But_add" >
...
<?php endif; ?>
                                            <span class="price"><?php echo $product['price'];?></span><span  class="price">грн</span>
                                        ...
                                        </button><a href="#" class="btn btn-default add-to-cart" data-quantity="1"  data-id="<?php echo $product['id']; ?>" ><i class="fa fa-shopping-cart"></i>В корзину</a></span>
 ...
 <?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <p  class="text-body text-sm-center"><?php echo $product['description'];?></p>
                            
                    
</div> <div class="col-12">
<div class="recommended_items"><!--recommended_items-->
                    <h5 class="title text-center">Рекомендуемые товары</h3>
