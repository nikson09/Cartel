...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/cssForSearch.css') }}">
    @yield('style')
</head>
<body>
<div id="app">
            ...
            <div class="navbar_header ">
                <div class="row">
                    <a href="/" class="navbar-brand">
                        <img class="lazy"
                             src="data:image/gif;base64,R0lGODlh1wBDAIAAAP///wAAACH5BAEAAAEALAAAAADXAEMAAAKQjI+py+0Po5y02ouz3rz7D4biSJbmiabqyrbuC8fyTNf2jef6zvf+DwwKh8Si8YhMKpfMpvMJjUqn1Kr1is1qt9yu9wsOi8fksvmMTqvX7Lb7DY/L5/S6/Y7P6/f8vv8PGCg4SFhoeIiYqLjI2Oj4CBkpOUlZaXmJmam5ydnp+QkaKjpKWmp6ipqqusraylIAADs="
                             data-src="{{ asset('images/картель.png') }}" alt="" class="">
                    </a>
                    <div class="modal fade" id="exampleModalLong_pc" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <h6>- Перечислением на банковскую карту (номер и сумму отправляем смс
                                        сообщением)</h6>
                                    ...
                                    <H4>Прочее</H4>
                                    Вся продукция сертифицирована и имеет документальное подтверждение в виде
                                    сертификата соответствия (отправляется вместе с товаром по просьбе заказчика).
                                    В соответствии с законодательством Украины в сфере алкогольной продукции, если
                                    алкогольный напиток крепостью до 8,5%, то он не подлежит акцизному маркированию.
                                    Вся импортная продукция разливается не на территории Украины.
                                    Этикетки, которые находятся на задней части бутылки (в некоторых случаях все
                                    этикетки на бутылке) заказываются компанией импортером и вместе с акцизными марками
                                    отправляются на завод изготовитель для последующей маркировки.
                                    <H4>....</H4>
                                    При предоставлении персональных данных на Сайте Магазина, Клиент дает свое
                                    добровольное согласие на обработку и использование (в том числе и передачу) своих
                                    персональных данных без ограничения срока действия такого согласия в соответствии с
                                    Законом Украины «О защите персональных данных» от 01.06.2010 г.
                                    Cайт Магазина вправе использовать персональные данные Клиента для оказания
                                    определенных настоящим договором услуг, в том числе и при помощи автоматизированной
                                    обработки персональных данных.
                                    Cайт Магазина берет на себя обязанность не разглашать персональные и контактные
                                    данные полученные от Клиента.
                                    Клиент несет ответственность за несоответствие своих персональных данных
                                    действительности.
                                    Cайт Магазина не несет ответственности за несоответствие персональных данных
                                    Клиента.
                                </div>
                    ...
                    <div class="d7">
                        <form id="form" action="{{ route('searchResults') }}" method="GET">
                            <!-- Изменили на searchResults -->
                            <div class="row">
                                <div class="search">
                                    <input type="text" id="search_input" name="s_search5" autocomplete="off"
                    ...
                    <div class="auth noAuth topNavBlock">
                        ...
                        <div class="modal_button">
                            <button type="button" class="btn btn-link" data-toggle="modal"
                                    data-target="#exampleModalLong_pc">
                ...
                <ul class="super-menu mobile-menu menu-floated">
                    @foreach(\App\BarMenu::where('active', true)->orderBy('sort_order', 'Asc')->get() as $barMenu)
                        <li class="drop-down float-left main-menu-item-1">
                            <a href="{{ $barMenu->href }}"
                               style="background-image: url({{ Storage::url('public/bar-menu/'. $barMenu->image) }});">
    ...
    <main class="py-4" id="desktop" v-if="!isMobile">
        ...
        <div class="container">
            <div class="row">
                ...
                @if(Route::currentRouteName() == 'searchResults')
                    <filter-section
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                    ...
                    <div id="basket-modal-body">
                        <div class="d-flex justify-content-end" style="margin-bottom: 1vw;">
                            <button type="button" class="btn btn-outline-danger"
                                    onclick="removeAllProductsFromBasket()">Очистить корзину
                            </button>
                        </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <h5>Всего: <span class="price text-primary"><span id="total_cart_sum">0</span> грн</span>
                            </h5>
                        </div>
                    </div>
                ...
                <div class="modal-footer border-top-0 d-flex justify-content-between">
                    ...
                    <a type="button" class="btn btn-outline-primary" id="checkout_button" href="/checkout">Оформить
                        заказ</a>
                </div>
            </div>
        </div>
    ...
    <footer id="footer" v-if="!isMobile"><!--Footer-->
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="col-4"><img class="lazy autor"
                                          src="data:image/gif;base64,R0lGODlh1wBDAIAAAP///wAAACH5BAEAAAEALAAAAADXAEMAAAKQjI+py+0Po5y02ouz3rz7D4biSJbmiabqyrbuC8fyTNf2jef6zvf+DwwKh8Si8YhMKpfMpvMJjUqn1Kr1is1qt9yu9wsOi8fksvmMTqvX7Lb7DY/L5/S6/Y7P6/f8vv8PGCg4SFhoeIiYqLjI2Oj4CBkpOUlZaXmJmam5ydnp+QkaKjpKWmp6ipqqusraylIAADs="
                                          data-src="{{ asset('images/autor.png') }}" alt="" class="autor"></p>

                    <p class="col-8 text-sm-right">
                        <img class="lazy autor_site"
                             src="data:image/gif;base64,R0lGODlh1wBDAIAAAP///wAAACH5BAEAAAEALAAAAADXAEMAAAKQjI+py+0Po5y02ouz3rz7D4biSJbmiabqyrbuC8fyTNf2jef6zvf+DwwKh8Si8YhMKpfMpvMJjUqn1Kr1is1qt9yu9wsOi8fksvmMTqvX7Lb7DY/L5/S6/Y7P6/f8vv8PGCg4SFhoeIiYqLjI2Oj4CBkpOUlZaXmJmam5ydnp+QkaKjpKWmp6ipqqusraylIAADs="
                             data-src="{{ asset('images/картель.png') }}" alt="">
                    </p>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        $searchInput.on('input', function () {
            ...
            if (query.length > 0) {
                $.ajax({
                    url: '/bestsearch',
                    method: 'GET',
                    data: {s_search5: query},
                    success: function (results) {
                        console.log('test:', results); // Выводим данные в консоль

                        if (results.length > 0) {
                            $searchResults.html(results.map(product => `
                                <a href="/product/${product.id}" class="search-result-item">
                                    <img src="/storage/products/${product.image}" alt="${product.name}" class="search-result-image">
                                    <span class="search-result-name">${product.name}</span>
                                    <div class="search-result-price">
                                        ${product.discount_percent > 0 ? `
                                            <span class="original-price">${product.sum}₴</span>
                                            <span class="discount-percent">-${product.discount_percent}%</span>
                                            <span class="discounted-price">${product.discount_sum}₴ </span>
                                        ` : `
                            ...
                            $searchResults.html('<div class="search-no-results">Ничего не найдено</div>');
                            $searchResults.show();
                        }
                    },
                    error: function () {
                        console.error('Ошибка при загрузке результатов поиска.');
                    }
                });
            } else {
                $searchResults.hide();
        ...
        // Скрытие модального окна при клике вне области
